...
import SivIks from "../../images/siv-iks.png";

const PopUp = ({ handlePopup }) => {
  return (
    <div className="popup-everything-together">
      <div className="blurred-popup-layer"></div>
        ...
        <div className="popup-container">
          ...
          <div className="popup-form-container">
            ...
            <div className="popup-btn-container">
              <button className="popup-btn">Send request</button>
            </div>
          </div>
        </div>
      </div>
