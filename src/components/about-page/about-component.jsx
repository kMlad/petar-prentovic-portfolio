    ...
    <div className="about-container">
      ...
      <div className="paragraph-container">
        <p className="bio-text">
          Entrepreneurial and hardworking UX/UI Designer,
          <br /> looking for a design related opportunities. After <br />{" "}
          completing an extensive graphic design program, <br />
          found my new passion for UX/UI. What really fires me
          <br /> up is building great products and being engaged <br />
          with people who want to unlock their potential. <br />
          <br />I enjoy solving complex problems and turning them <br />
          into simple and beautiful interface designs.
          <br />
          <br /> When I'm not designing you will find me going for
          <br /> long walks or shooting some hoops.
        </p>
      </div>
      <svg
